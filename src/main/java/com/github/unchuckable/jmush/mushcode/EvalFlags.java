 ...
 * </ul>
 *
 * Not modeled (no observable effect yet, since the corresponding feature doesn't exist): EV_FMAND
 * (needs the Value error-message system), EV_NO_LOCATION (needs %l), EV_EVAL/EV_TOP/
 * EV_NOTRACE/EV_STRIP_TS/EV_STRIP_LS/EV_STRIP_ESC/EV_STRIP_AROUND (all narrower call-site concerns,
 * not general parse-time semantics).
 */
